          ...
          <CardContent className="space-y-6">
              ...
              <TabsContent value="admin" className="mt-6">
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-3 mb-4">
                  <div className="flex items-center space-x-2 text-primary">
                    ...
                    <span className="text-sm font-medium">Admin Portal Access</span>
                  </div>
                  <p className="text-xs text-primary/80 mt-1">
                    Access fleet management, analytics, and operational controls
                  </p>
                </div>
              </TabsContent>
              ...
              <TabsContent value="rider" className="mt-6">
                <div className="bg-success/10 border border-success/20 rounded-lg p-3 mb-4">
                  <div className="flex items-center space-x-2 text-success">
                    <Car className="w-4 h-4" />
                    <span className="text-sm font-medium">Rider Dashboard</span>
                  </div>
                  <p className="text-xs text-success/80 mt-1">
                    Book rides, track trips, and manage your account
                  </p>
                </div>
              </TabsContent>
            </Tabs>
            ...
            <div className="bg-muted/50 rounded-lg p-3 text-center">
              ...
              <div className="text-xs space-y-1">
                ...
                <div><strong>Rider:</strong> rider@demo.com / rider123</div>
              </div>
            </div>
          </CardContent>
        </Card>
